...
export const Card = ({
  ...
  return (
    <div
      className={`${css} bg-[#cccccc] shadow-2xl dark:shadow-slate-900 dark:shadow-lg dark:bg-preto_secondario dark:bg-opacity-90 bg-opacity-60  mb-12 flex min-h-[20em] max-w-7xl items-center justify-center rounded-lg tracking-widest leading-tighter
        ...
        >
          <div className="flex-col gap-6 w-full flex-[0_0_auto] flex items-center relative self-stretch">
            <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <p
                className={`font-semibold text-laranja  text-pretty dark:text-laranja`}
              >
                {subTitulo}
              </p>
            </div>
