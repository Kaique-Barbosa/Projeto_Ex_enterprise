...
export const Card = ({ 
  ...
  return (
      <div
        className= {`  flex flex-wrap m-auto w-[80%] h-[500px] items-center justify-center "
        data-responsividade-mode= ${larguraDaTela}
        `}
      >
        <div className= {` ${inverter ? "transform -scale-x-100": ''} bg-[#161414] !w-[80%] m-auto  justify-between flex-1 grow bg-cores-container-fundo rounded-2xl flex items-center  self-stretch`}>
          <Image
            ...
            height={50}
          />
          <div className={` ${inverter ? " items-end ": 'items-start '} flex flex-col  justify-center gap-8 p-8 relative flex-1 self-stretch grow`}>
